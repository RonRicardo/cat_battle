...
class TrainersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trainer" do
    assert_difference('Trainer.count') do
      post trainers_url, params: { trainer: { password_digest: @trainer.password_digest, username: @trainer.username } }, as: :json
    end
  ...
  test "should update trainer" do
    patch trainer_url(@trainer), params: { trainer: { password_digest: @trainer.password_digest, username: @trainer.username } }, as: :json
    assert_response 200
  end
